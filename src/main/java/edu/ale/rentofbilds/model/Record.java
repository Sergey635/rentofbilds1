...
public class Record {
    ...
    public Record(String name, String description, LocalDateTime start, LocalDateTime finish, Client client, Build build, LocalDateTime created_at, LocalDateTime modified_at) {
        this.name = name;
        this.description = description;
        this.start = start;
        this.finish = finish;
